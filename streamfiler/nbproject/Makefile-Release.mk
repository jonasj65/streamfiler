...
${OBJECTDIR}/clientsocket.o: clientsocket.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clientsocket.o clientsocket.cpp

${OBJECTDIR}/filenamegenerator.o: filenamegenerator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/filenamegenerator.o filenamegenerator.cpp

${OBJECTDIR}/filewriter.o: filewriter.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/filewriter.o filewriter.cpp

${OBJECTDIR}/iparameters.o: iparameters.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/iparameters.o iparameters.cpp

${OBJECTDIR}/itimerexec.o: itimerexec.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/itimerexec.o itimerexec.cpp
...
${OBJECTDIR}/parameters.o: parameters.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parameters.o parameters.cpp

${OBJECTDIR}/path.o: path.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/path.o path.cpp
...
${OBJECTDIR}/serversocket.o: serversocket.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/serversocket.o serversocket.cpp

${OBJECTDIR}/stringtool.o: stringtool.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stringtool.o stringtool.cpp

${OBJECTDIR}/timedexecutor.o: timedexecutor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/timedexecutor.o timedexecutor.cpp
...
${TESTDIR}/tests/FileNameGeneratorTest.o: tests/FileNameGeneratorTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/FileNameGeneratorTest.o tests/FileNameGeneratorTest.cpp


${TESTDIR}/tests/ParametersTest.o: tests/ParametersTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ParametersTest.o tests/ParametersTest.cpp


${TESTDIR}/tests/PathTest.o: tests/PathTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PathTest.o tests/PathTest.cpp


${TESTDIR}/tests/StringToolTest.o: tests/StringToolTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/StringToolTest.o tests/StringToolTest.cpp


${TESTDIR}/tests/streamfilertestrunner.o: tests/streamfilertestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/streamfilertestrunner.o tests/streamfilertestrunner.cpp
...
${OBJECTDIR}/clientsocket_nomain.o: ${OBJECTDIR}/clientsocket.o clientsocket.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clientsocket_nomain.o clientsocket.cpp;\
	else  \
...
${OBJECTDIR}/filenamegenerator_nomain.o: ${OBJECTDIR}/filenamegenerator.o filenamegenerator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/filenamegenerator_nomain.o filenamegenerator.cpp;\
	else  \
...
${OBJECTDIR}/filewriter_nomain.o: ${OBJECTDIR}/filewriter.o filewriter.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/filewriter_nomain.o filewriter.cpp;\
	else  \
...
${OBJECTDIR}/iparameters_nomain.o: ${OBJECTDIR}/iparameters.o iparameters.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/iparameters_nomain.o iparameters.cpp;\
	else  \
...
${OBJECTDIR}/itimerexec_nomain.o: ${OBJECTDIR}/itimerexec.o itimerexec.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/itimerexec_nomain.o itimerexec.cpp;\
	else  \
...
${OBJECTDIR}/parameters_nomain.o: ${OBJECTDIR}/parameters.o parameters.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parameters_nomain.o parameters.cpp;\
	else  \
...
${OBJECTDIR}/path_nomain.o: ${OBJECTDIR}/path.o path.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/path_nomain.o path.cpp;\
	else  \
...
${OBJECTDIR}/receiver_nomain.o: ${OBJECTDIR}/receiver.o receiver.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/receiver_nomain.o receiver.cpp;\
	else  \
...
${OBJECTDIR}/serversocket_nomain.o: ${OBJECTDIR}/serversocket.o serversocket.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/serversocket_nomain.o serversocket.cpp;\
	else  \
...
${OBJECTDIR}/stringtool_nomain.o: ${OBJECTDIR}/stringtool.o stringtool.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stringtool_nomain.o stringtool.cpp;\
	else  \
...
${OBJECTDIR}/timedexecutor_nomain.o: ${OBJECTDIR}/timedexecutor.o timedexecutor.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/timedexecutor_nomain.o timedexecutor.cpp;\
	else  \
